                ...
                <table id="example1" class="table table-hover">
                    ...
                    <tbody id="datatable">
                        <tr>
                            ...
                            <td> 4</td>
                            <td>
                                <a link="#" class="btn btn-primary btn-sm edit text-light border-0 edit" rel="tooltip" id="edit" title="Edit" data-id="4" data-bs-toggle="modal" data-bs-target="#edit_modal" data-bs-whatever="@mdo">
