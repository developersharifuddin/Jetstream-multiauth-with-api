...
@section('breadcrumb')
<li class="breadcrumb-item h5"><a href="{{route('admin.dashboard')}}">All Category</a></li>
...
<span class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addModal"> Add Category</span>
@endsection
    ...
    <div class="col-12 p-0">
        <div class="card">
            <div class="card-header justify-content-between">
                <h3 class="card-title float-left pt-2">Category List</h3>
                    ...
                    <tbody id="datatable">
                        <tr>
                            ...
                            <td>
                                ...
                                <a link="#" data-id="4" class="btn btn-sm btn-danger shadow border-0 delete" id="delete">
